// backend/routes/maestro/aulas_estado.js
// backend/routes/maestro/aulas_estado.js
...
/**
 * GET /api/maestro/aulas/estado-actual?pre=10&tail=10
 * Clasifica las aulas del maestro como:
 ...
 */
router.get("/estado-actual", authenticateMaestro, async (req, res) => {
  try {
    ...
    // Trae aulas del maestro (solo campos necesarios)
